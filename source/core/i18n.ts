...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'help.whatIsDesc1': 'Agent Orchester — AI coding tool orchestration profile manager.',
    ...
    'install.legend': '✓ = agent orchester profile  ● = on system',
  ...
  ko: {
    ...
    'list.runtimes': '런타임',
    'list.system': '시스템',
    'list.welcome': 'agent orchester에 오신 것을 환영합니다!',
    'list.noProfiles': '설치된 프로파일이 없습니다.',
    'list.pressInstall': '{key}을 눌러 레지스트리에서 설치하거나,',
    'list.pressHelp': '{key}을 눌러 도움말을 확인하세요.',

    'help.whatIs': 'agent orchester란?',
    'help.whatIsDesc1': 'Agent Orchester — AI 코딩 도구를 위한 오케스트레이션 프로파일 관리자입니다.',
    ...
    'install.legend': '✓ = agent orchester 프로파일  ● = 시스템에 존재',
    ...
    'install.cannotOverwrite': 'agent orchester는 활성 설치를 덮어쓸 수 없습니다.',
    'install.evidence': '근거:',
    'install.uninstallFirst': 'agent orchester로 관리하려면 먼저 원본 소스에서 제거한 후, agent orchester를 통해 설치하세요.',
  ...
  ja: {
    ...
    'list.runtimes': 'ランタイム',
    'list.system': 'システム',
    'list.welcome': 'agent orchesterへようこそ！',
    'list.noProfiles': 'インストール済みのプロファイルがありません。',
    'list.pressInstall': '{key}でレジストリからインストール、',
    'list.pressHelp': '{key}でヘルプを表示。',

    'help.whatIs': 'agent orchesterとは？',
    'help.whatIsDesc1': 'Agent Orchester — AIコーディングツール向けオーケストレーションプロファイル管理ツール。',
    ...
    'install.legend': '✓ = agent orchesterプロファイル  ● = システム上',
    ...
    'install.cannotOverwrite': 'agent orchesterはアクティブなインストールを上書きできません。',
    'install.evidence': '根拠:',
    'install.uninstallFirst': 'agent orchesterで管理するには、まず元のソースからアンインストールし、agent orchesterでインストールしてください。',
  ...
  zh: {
    ...
    'list.runtimes': '运行时',
    'list.system': '系统',
    'list.welcome': '欢迎使用 agent orchester！',
    'list.noProfiles': '尚未安装任何配置文件。',
    'list.pressInstall': '按 {key} 从注册表浏览并安装，',
    'list.pressHelp': '或按 {key} 查看帮助。',

    'help.whatIs': '什么是 agent orchester？',
    'help.whatIsDesc1': 'Agent Orchester — 面向AI编程工具的编排配置文件管理器。',
    ...
    'install.legend': '✓ = agent orchester配置文件  ● = 系统上存在',
    'install.activeOnSystem': '系统上已激活',
    'install.activeWarning': '{tools} — 安装不会影响当前设置。稍后激活将替换当前层。',
    'install.blocked': '{name} 已安装在您的系统上',
    'install.cannotOverwrite': 'agent orchester 无法覆盖已激活的安装。',
    'install.evidence': '证据:',
    'install.uninstallFirst': '要用 agent orchester 管理，请先从原始来源卸载，然后通过 agent orchester 安装。',
